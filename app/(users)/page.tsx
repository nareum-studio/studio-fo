      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <section className="text-left space-y-6 mb-20">
          ...
          <p className="leading-relaxed text-gray-800">
            나름다움 스튜디오는 인위적인 장치보다는 쏟아지는 햇살 아래에서 가장
            선명해지는 나의 아름다운 본질을 기록하는 기록 공간입니다.
          </p>
          ...
          <p className="leading-relaxed text-gray-700">
            ...
            담아내기 때문입니다. 창을 통해 들어오는 부드러운 빛은 피부의 질감을
            투명하게 표현하고, 눈동자에 인위적인 생기가 아닌 따스한 온기를
            채워줍니다.
            <br className="mb-2" />
        ...
        <section className="text-gray-700 leading-relaxed space-y-6 mb-16">
          <p>
            ...
            그러나 미처 발견하지 못했던 ‘나다운 결’을 빛으로 현상해 내는
            조력자가 되고 싶습니다.
          </p>

          <p>
            햇살이 머무는 자리는 언제나 따뜻하고 부드럽습니다. 나름다움
            스튜디오에서의 시간이 당신의 삶에서 가장 편안한 기록으로 남기를
            바랍니다.
          </p>
        ...
        <div className="text-center space-y-3">
          <p className="text-gray-600">당신의 고유한 빛을 기록합니다.</p>
